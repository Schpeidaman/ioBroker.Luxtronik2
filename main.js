 ...
 *  {
 *      "common": {
 *          "name":         "Luxtronik2",                  // name has to be set and has to be equal to adapters folder name and main file name excluding extension
 *          "version":      "0.0.0",                    // use "Semantic Versioning"! see http://semver.org/
 *          "title":        "Node.js Luxtronik2 Adapter",  // Adapter title shown in User Interfaces
 *          "authors":  [                               // Array of authord
 *              "name <mail@Luxtronik2.com>"
 *          ]
 *          "desc":         "Luxtronik2 adapter",          // Adapter description shown in User Interfaces. Can be a language object {de:"...",ru:"..."} or a string
...
var adapter = utils.adapter('Luxtronik2');
var net = require('net');
...
function main() {
    ...
    adapter.log.info('ioBroker.Luxtronik2 started');
}
